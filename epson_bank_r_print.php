...
<h2  style="transform: rotate(-90deg); margin: 368px  795px 0 -557px; margin-left: 5px; padding-top: 10px;"><?php  echo $data_fetch['ref']; ?></h2>

  <div class="rotate1"  style="margin: -360px 0 0 195px;">

  <!-- part 1 -->

  

  <h2 style="margin: 0 0 0 992px; line-height: 5px;"><?php echo date("j-m-Y") ?></h2>
    <?php 
    ...
    <h2 style="margin: -60px 0 0 527px; padding-top: 115px; "><?php  echo $data_fetch['register_type']; ?> Registered Graduate</h2>
    <h1 style="margin:15px 0 0 422px; line-height: -0px;"><?php if($data_fetch['register_type']=='Lifetime'){ echo 1200; } else{ echo "500";}?></h1>
...
<div class="rotate2" style="margin: -200px 0 0 188px;">
  ...
  <h2 style="margin: 0 0 0 858px; line-height: 5px;"><?php echo date("j-m-Y") ?></h2>
    ...
    <h2 style="line-height: 14px;"><?php  echo $data_fetch['mobile_no']; ?></h2>
     <p style="margin: 0 0 0 450px;  width: 564px; height: 57px; font-size: 28px; "><?php  echo $data_fetch['present_address']. ","; echo $data_fetch['present_thana']. ","; echo $data_fetch['present_district'] ;  ?></p>
    <h2 style="margin: -60px 0 0 527px; padding-top: 108px; "><?php  echo $data_fetch['register_type']; ?> Registered Graduate</h2>
    <h1 style="margin: 15px 0 0 434px; line-height: -0px;"><?php if($data_fetch['register_type']=='Lifetime'){ echo 1200; } else{ echo "500";}?></h1>
    <h2 style="margin: -10px 0 0 331px; padding-top: 12px;"><?php if($data_fetch['register_type']=='Lifetime'){ echo 'One Thousend Two Hundred'; } else{ echo "Five hundred";}?> Taka Only</h2>
   
</div>
<div class="rotate3"  style="margin:-205px 0 0 188px;">
