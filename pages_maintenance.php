...
<html lang="en">
    ...
    <body>
        <div class="home-btn d-none d-sm-block">
            <a href="template/login.php"><i class="mdi mdi-home-variant h2"></i></a>
        </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-7">
                        <div class="text-center mb-5">
                            <div class="mb-5">
                                <img src="uploads/logo/university-of-dhaka.jpg" height="100" alt="logo">
                            </div>
                                ...
                                <div class="card-body p-4">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <p class="text-muted mb-0">If you need support or something to tell us . Then send a screenshot in email or tell us what's the problem. In this 
                                            <a href="https://mail.google.com/mail/u/0/#inbox?compose=CllgCJTKWVMdHzFHqTxmQzhmJLHjSkmtqLDjcRGfbwMSXKHMDTsLHCKjthldqdkXmxZPJrDFBqB"
                                            class="text-decoration-underline">kazitoha03@gmail.com</a>
                                             gmail and send it. </p>
                                        </div>
                                    </div>
                                </div>
